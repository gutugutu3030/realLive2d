...
public class Vector {
   ...
   * @return a new vector that is the sum of v1 and v2
   */
  public static Vector add(Vector v1, Vector v2, Vector target) {
    if (target == null) {
   ...
   */
  public static Vector mult(Vector v, double n, Vector target) {
    if (target == null) {
  ...
  /**
   * Multiply each element of one vector by the individual elements of another vector, and return
  ...
  /**
   * Multiply each element of one vector by the individual elements of another vector, and write the
   * result into a target vector.
   *
   * @param v1 the first vector
   * @param v2 the second vector
   * @param target Vector to store the result
   */
  public static Vector mult(Vector v1, Vector v2, Vector target) {
    if (target == null) {
      target = new Vector(v1.x * v2.x, v1.y * v2.y, v1.z * v2.z);
    } else {
      target.set(v1.x * v2.x, v1.y * v2.y, v1.z * v2.z);
  ...
  public static Vector div(Vector v, double n, Vector target) {
    if (target == null) {
      target = new Vector(v.x / n, v.y / n, v.z / n);
    } else {
      target.set(v.x / n, v.y / n, v.z / n);
  ...
  /**
   * Divide each element of one vector by the individual elements of another vector, and write the
   * result into a target vector.
   *
   * @param v1 the first vector
   * @param v2 the second vector
   * @param target Vector to store the result
   */
  public static Vector div(Vector v1, Vector v2, Vector target) {
    if (target == null) {
      target = new Vector(v1.x / v2.x, v1.y / v2.y, v1.z / v2.z);
    } else {
      target.set(v1.x / v2.x, v1.y / v2.y, v1.z / v2.z);
  ...
  /**
   * Perform cross product between this and another vector, and store the result in 'target'. If
   * target is null, a new vector is created.
   */
  ...
  public static Vector cross(Vector v1, Vector v2, Vector target) {
  ...
  /**
   * Return a representation of this vector as a double array. This is only for temporary use. If
   * used in any other fashion, the contents should be copied by using the get() command to copy
   * into your own array.
   */
  public double[] array() {
    if (array == null) {
